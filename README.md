...
- upstream release: v2.18.0
- exact upstream commit: 389390c884949fe27c240488a3259da3cdba93e0
...
The current source-offer release is `documenso-v2.18.0-millave.1`. It
supersedes `documenso-v2.15.0-millave.2` by re-pinning the same patch
content to upstream release v2.18.0.
...
It also does not copy the upstream source tree. The exact upstream v2.18.0
